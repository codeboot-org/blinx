...
host_eval('(function (html) { var body = document.querySelector("#cb-body"); CodeBoot.prototype.open = function() { body.innerHTML = ""; rte.vm.setHidden(false); }; body.innerHTML = html; })')(html)
